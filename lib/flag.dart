...
class _FlagState extends State<Flag> {
  int? indesx;
  final List list_s=[
    "Afganistan","Bangladesh","India","America","Portogal"
  ];
  @override
      ...
      child: Padding(
        ...
        child: Card(
         ...
         child: Padding(
           padding: const EdgeInsets.all(8.0),
           child: ListTile(
             leading: Text("${list_s[index]}",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold)),
             trailing: Container(
               height: 40,
               width: 40,
               decoration: BoxDecoration(
                 shape: BoxShape.circle,
                 color: indesx==index?Colors.orange:Colors.transparent
               ),
